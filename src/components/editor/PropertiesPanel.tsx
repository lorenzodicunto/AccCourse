...
export function PropertiesPanel() {
  ...
  return (
    <div className="w-[280px] border-l border-slate-200 flex flex-col flex-shrink-0 overflow-hidden" style={{ background: '#FFFFFF' }}>
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden h-0">
        {/* Modern Tab Header */}
        ...
        {/* ─── ABA INSERIR ─── */}
        <TabsContent value="insert" className="m-0 flex-1 overflow-hidden flex flex-col h-0">
        ...
        {/* ─── ABA DESIGN ─── */}
        <TabsContent value="design" className="m-0 flex-1 overflow-hidden flex flex-col h-0">
          <ScrollArea className="flex-1 h-0">
            {block ? (
          <div>
            {/* Block Header */}
